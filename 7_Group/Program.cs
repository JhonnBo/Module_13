namespace _7_Group
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("------------- Количество телефонов по группам --------");
            ...
            Console.WriteLine("\n------- Количество телефонов по группам (методы) -------");
            ...
            Console.WriteLine("------------- Количество телефонов и их количество по группам --------");
            ...
            Console.WriteLine("------- Количество телефонов и их количество по группам (методы) --------");
            ...
            string[] websites = { "microsoft.com", "asp.net", "php.net", "championat.com", 
                "wikipedia.org", "itstep.org", "odessa.tv", "football.ua", "yandex.ru", "rozetka" };
